...
export default function NewMeasurementsScreen() {
  ...
  async function save() {
    ...
    router.replace(`/measurements/${data.id}`)
  }
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <TouchableOpacity
          ...
          disabled={loading}
        >
          <Text style={styles.buttonText}>{loading ? 'Saving…' : 'Save Measurements'}</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  headerSide: { width: 80 },
  headerTitle: { fontFamily: fonts.serifBold, fontSize: 17, color: colors.warmWhite, textAlign: 'center' },
